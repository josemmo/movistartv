...
import tk.josemmo.movistartv.R;
 ...
 */
public class RichSetupFragment extends ChannelSetupStepFragment<JobService> {
    ...
    @Override
    public Class<JobService> getEpgSyncJobServiceClass() {
